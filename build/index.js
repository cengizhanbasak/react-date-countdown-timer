...
var DateCountdown = function (_Component) {
  ...
  _createClass(DateCountdown, [{
    ...
    value: function componentWillUnmount() {
      var tickId = this.state.tickId;

      clearInterval(tickId);
    }
  }, {
    key: 'animateAndChangeIfNeeded',
    value: function animateAndChangeIfNeeded(unit, prevUnit) {
      var _this3 = this;
          ...
          if (significance.indexOf(unit) !== -1) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _this4.dissect(state[unit], unit)
              ),
              ' ',
